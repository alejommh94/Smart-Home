...
- 💡 Luces — Control y estado de cada zona
- 🔒 Seguridad — Estado de puertas, alarmas y alertas
- 📷 Cámaras — Vista rápida de cámaras activas y offline
...
git clone https://github.com/alejommh94/Smart-Home.git
- Abre el archivo:
hogar.html
- Disfruta del dashboard en tu navegador.
